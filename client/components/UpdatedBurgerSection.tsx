              ...
              <div className="bg-white rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-700 border border-gray-100 group-hover:rotate-1">
                ...
                <div className="p-8">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <button className="bg-flat-blue text-flat-beige px-6 py-3 rounded-full font-bold tracking-wider uppercase hover:bg-flat-dark transition-all duration-300 transform hover:scale-105" style={{fontFamily: 'Bricolage Grotesque'}}>
                      Order
                    </button>
                  </div>
                </div>
