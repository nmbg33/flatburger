      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between">
          ...
          <div className="md:hidden flex items-center space-x-3">
            <button
              onClick={toggleLanguage}
              className="flex items-center space-x-1 bg-flat-blue text-flat-beige px-3 py-2 rounded-full text-xs font-bold transition-colors duration-200"
              style={{ fontFamily: "Bricolage Grotesque" }}
            >
              <Globe size={14} />
              <span>SRB/ENG</span>
            ...
            <button
              ...
              className={`text-flat-blue p-3 rounded-lg transition-colors duration-200 ${
                isMenuOpen ? "bg-flat-blue/20" : "hover:bg-flat-blue/10"
              }`}
        ...
        <div
          className={`md:hidden absolute top-full left-0 right-0 bg-flat-beige border-t border-flat-blue/10 shadow-xl transition-all duration-300 ease-out ${
            isMenuOpen
