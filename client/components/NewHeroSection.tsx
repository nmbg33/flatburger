  ...
  return (
    <section className="relative h-screen flex items-center justify-center overflow-hidden bg-flat-beige">
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
        ...
        >
          <h1
            className="text-4xl md:text-6xl lg:text-8xl font-black text-flat-blue mb-6 leading-tight tracking-tight"
        ...
        >
          <p
            className="text-xl md:text-2xl lg:text-3xl text-flat-blue/80 mb-12 font-medium"
            style={{ fontFamily: "Bricolage Grotesque" }}
          >
            {t("hero.subtitle")}
          </p>
