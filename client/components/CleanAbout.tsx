  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 opacity-10">
        ...
        <div className="absolute top-8 left-8 w-8 h-px bg-flat-cream/20"></div>
        <div className="absolute top-8 left-8 w-px h-8 bg-flat-cream/20"></div>

        <div className="absolute bottom-8 right-8 w-6 h-px bg-flat-cream/15"></div>
        <div className="absolute bottom-8 right-8 w-px h-6 bg-flat-cream/15"></div>
      </div>
