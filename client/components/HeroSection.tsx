  ...
  return (
    <section className="min-h-screen bg-gradient-to-br from-flat-cream via-flat-cream to-[#F0E68C] relative overflow-hidden flex items-center justify-center">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-20 left-10 w-8 h-8 bg-flat-blue/20 rounded-full animate-bounce" style={{animationDelay: '0s'}}></div>
        <div className="absolute top-40 right-20 w-6 h-6 bg-flat-blue/20 rounded-full animate-bounce" style={{animationDelay: '1s'}}></div>
        <div className="absolute bottom-40 left-20 w-10 h-10 bg-flat-blue/20 rounded-full animate-bounce" style={{animationDelay: '2s'}}></div>
        <div className="absolute bottom-20 right-10 w-4 h-4 bg-flat-blue/20 rounded-full animate-bounce" style={{animationDelay: '1.5s'}}></div>
        
        {/* Wavy sauce drips */}
        <svg className="absolute top-0 left-0 w-full h-full opacity-10" viewBox="0 0 100 100" preserveAspectRatio="none">
          <path d="M0,20 Q25,10 50,20 T100,20 L100,0 L0,0 Z" fill="#1B35EF" className="animate-pulse" />
          <path d="M0,80 Q25,90 50,80 T100,80 L100,100 L0,100 Z" fill="#1B35EF" className="animate-pulse" style={{animationDelay: '1s'}} />
        </svg>
      </div>
