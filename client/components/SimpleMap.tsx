    ...
    <div className="bg-white rounded-3xl overflow-hidden shadow-xl">
      ...
      <div className="relative">
        <div className="w-full h-96 bg-flat-beige/20 relative overflow-hidden">
          {/* OpenStreetMap Embed */}
          <iframe
            src={`https://www.openstreetmap.org/export/embed.html?bbox=${(location.lng - 0.0012).toFixed(4)}%2C${(location.lat - 0.0012).toFixed(4)}%2C${(location.lng + 0.0012).toFixed(4)}%2C${(location.lat + 0.0012).toFixed(4)}&layer=mapnik&marker=${location.lat}%2C${location.lng}`}
