  ...
  return (
    ...
    >
      ...
      <div className="max-w-6xl mx-auto text-center relative z-10">
        ...
        {/* Floating Elements */}
        <div
          className={`mt-16 flex justify-center items-center space-x-12 transition-all duration-1000 ease-out delay-600 ${
            isVisible
              ? "opacity-100 transform translate-y-0"
              : "opacity-0 transform translate-y-12"
          }`}
        >
          ...
          <div
            className="w-24 h-1 bg-flat-cream animate-float"
