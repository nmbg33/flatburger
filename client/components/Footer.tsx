    ...
    <footer className="bg-flat-dark text-flat-cream py-12 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-10">
        <div className="absolute top-0 left-0 w-full h-full">
          ...
          <div
            className="absolute top-20 right-20 w-6 h-6 bg-flat-cream rounded-full animate-pulse"
            style={{ animationDelay: "1s" }}
          ></div>
          <div
            className="absolute bottom-10 left-1/4 w-4 h-4 bg-flat-cream rounded-full animate-pulse"
            style={{ animationDelay: "2s" }}
          ></div>
          <div
            className="absolute bottom-20 right-1/3 w-10 h-10 bg-flat-cream rounded-full animate-pulse"
